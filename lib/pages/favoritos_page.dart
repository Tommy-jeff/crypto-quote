      ...
      headerSliverBuilder:
          (context, __) => [
            SliverAppBar(
              ...
              actions: [IconButton(onPressed: () => {}, icon: const Icon(Icons.swap_vert), color: Colors.white)],
            ),
          ],
      body: Scaffold(
        body: Container(
          ...
          child:
              favCoinsList.isEmpty
                  ? ListTile(leading: Icon(Icons.star), title: Text("Ainda não há favoritos"))
                  : ListView.builder(
